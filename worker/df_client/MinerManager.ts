...
// Hack to fix "ReferenceError: name is not defined" in @darkforest_eth/hashing/dist/fractions/bigFraction.js:43
(global as any).name = "An unspecified error occurred (MinerManager.ts)";
